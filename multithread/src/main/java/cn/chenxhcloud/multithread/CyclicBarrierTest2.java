...
* 类名称：cn.chenxhcloud.multithread.CyclicBarrierTest2
* @author：chenxh  
...
public class CyclicBarrierTest2 {
	 ...
	 *  
	 *  CyclicBarrier还提供一个更高级的构造函数CyclicBarrier（int parties，Runnable barrier-Action），用于在线程到达屏障时，
	...
	static CyclicBarrier c = new CyclicBarrier(3,()->{ 
		//总结一下
		System.out.println(Thread.currentThread().getName()+ " all done??? continue ...");
	}) ;
